  ...
  const highlights = [
    {
      ...
      description: "Specialized in building full-stack applications with MongoDB, Express, React, and Node.js"
    },
    {
      icon: GraduationCap,
      title: "Education",
    ...
    },
    {
      icon: Users,
      title: "User-Centric",
      description: "Passionate about creating intuitive, scalable solutions that solve real-world problems"
    },
    {
      icon: Target,
      title: "Mission",
      description: "Committed to delivering high-quality, maintainable code with exceptional user experiences"
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              efficient code and staying updated with the latest industry trends and best practices.
            </p>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              ...
              and user experience, always striving to create applications that are not 
            ...
            <Card className="p-6 shadow-card hover:shadow-glow transition-smooth">
              ...
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  <span>User experience drives every technical decision</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                  <span>Clean, maintainable code is essential for scalability</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                  <span>Continuous learning keeps skills sharp and relevant</span>
                </li>
                <li className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0" />
                  <span>Collaboration and communication are key to success</span>
                </li>
              </ul>
            </Card>
