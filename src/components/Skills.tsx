      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {skillCategories.map((category, index) => {
            ...
            return (
              <Card key={index} className="p-6 shadow-card hover:shadow-glow transition-smooth">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {additionalSkills.map((skillSet, index) => {
            ...
            return (
              <Card key={index} className="p-6 text-center shadow-card hover:shadow-glow transition-smooth hover:scale-105">
