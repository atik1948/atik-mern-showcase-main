  ...
  const projects = [
    {
      ...
      description: "Full-featured e-commerce platform with user authentication, product catalog, shopping cart, and Stripe payment integration.",
      ...
      githubUrl: "https://github.com/atikwahid",
      gradient: "from-blue-500 to-purple-600"
    },
    {
      title: "Blog & CMS Platform",
      description: "Content management system with rich text editor, image upload capabilities, and role-based authentication for multiple user types.",
    ...
    },
    {
      ...
      description: "Interactive tool for creating professional portfolios and resumes with real-time preview and PDF export functionality.",
    ...
    },
    {
      ...
      description: "Modern chat application supporting one-to-one and group messaging with real-time updates and online/offline status.",
    ...
    },
    {
      ...
      description: "Collaborative task management tool with drag-and-drop functionality, team collaboration features, and project organization.",
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mt-12">
          ...
          <Button 
            ...
            asChild
          >
            <a href="https://github.com/atikwahid" target="_blank" rel="noopener noreferrer">
